...
export const ui: Record<Locale, Translation> = {
  en: {
    ...
    hero: {
      ...
      stats: ['Languages', 'Countries called home', 'Years in tech', 'Trails to chase'],
    },
    about: {
      eyebrow: 'About',
  ...
  el: {
    ...
    hero: {
      ...
      welcome:
        'Καλώς ήρθες στη μικρή μου γωνιά του διαδικτύου! Είμαι μια Ελληνίδα που ερωτεύτηκε το Μόναχο — Partner Solution Architect στη Microsoft τη μέρα και πεζοπόρος τον υπόλοιπο καιρό. Πάρε έναν καφέ, ρίξε μια ματιά και γνώρισέ με λίγο.',
      ctaPrimary: 'Επικοινώνησε μαζί μου',
      ctaSecondary: 'Τι κάνω',
      stats: ['Γλώσσες', 'Χώρες που αποκαλώ σπίτι μου', 'Χρόνια στην τεχνολογία', 'Μονοπάτια να εξερευνήσω'],
    },
    about: {
      eyebrow: 'Σχετικά',
      title: 'Λίγα λόγια για μένα',
      para1Html:
        '<span class="about-lead">👋 Γεια!</span> Είμαι Partner Solution Architect στην ομάδα EMEA<a href="#emea-note" class="footnote-ref" aria-label="Τι σημαίνει EMEA;">*</a> της Microsoft, με έδρα το Μόναχο. Κατάγομαι από τη Θεσσαλονίκη και μετακόμισα στο Μόναχο στα 23 μου, που έκτοτε το θεωρώ σπίτι μου. Δουλεύω με συνεργάτες για να χτίσουμε αξιόπιστες και οικονομικά αποδοτικές αρχιτεκτονικές Agentic AI, τους βοηθώ να διαμορφώσουν τις προσφορές cloud υπηρεσιών τους και προωθώ τον εκσυγχρονισμό του SDLC με γνώμονα το GitHub σε όλο το οικοσύστημα.',
      para2Html:
    ...
    focus: {
      ...
      lead: 'Τομείς όπου βοηθώ τους συνεργάτες της Microsoft να σχεδιάζουν, να χτίζουν και να παραδίδουν λύσεις.',
      weekTitle: 'Σε μια τυπική εβδομάδα',
      weekLead: 'Η δουλειά μου εστιάζει ιδιαίτερα στη γερμανική αγορά.',
      topics: [
        {
          title: 'Αρχιτεκτονικές Agentic AI',
          description:
            'Βοηθώ τους συνεργάτες να σχεδιάζουν και να αναπτύσσουν εφαρμογές AI που είναι αξιόπιστες, ασφαλείς και έτοιμες για παραγωγή — από το πρώτο prototype έως την παραγωγή, με έμφαση στο Microsoft Foundry.',
        },
        {
          title: 'Εκσυγχρονισμός του SDLC με γνώμονα το GitHub',
          description:
            'Προωθώ τον εκσυγχρονισμό του SDLC με γνώμονα το GitHub σε όλο το οικοσύστημα των συνεργατών — σύγχρονες ροές εργασίας για developers, αυτοματισμό και GitHub Copilot. Και ναι, αυτό το website φτιάχτηκε με GitHub Copilot.',
        },
      ],
      whatIDo: [
        'Παραδίδω τεχνικά trainings και πρακτικά workshops για την αναβάθμιση των δεξιοτήτων των ομάδων των συνεργατών',
        ...
        'Καθοδηγώ τους συνεργάτες σε αξιόπιστες, ασφαλείς και οικονομικά αποδοτικές λύσεις cloud και AI',
        'Προωθώ την υιοθέτηση του GitHub και της παραγωγικότητας των developers σε όλο το οικοσύστημα των συνεργατών',
      ],
    },
    experience: {
      eyebrow: 'Καριέρα',
      title: 'Επαγγελματική εμπειρία',
      lead: 'Πού έχω εργαστεί.',
      ...
      microsoft: [
        {
          ...
          summary:
            'Δουλεύω απευθείας με συνεργάτες σε όλη την EMEA πάνω σε αρχιτεκτονικές Agentic AI και στον εκσυγχρονισμό του SDLC με γνώμονα το GitHub, παρέχοντας τεχνική καθοδήγηση για τη δημιουργία αξιόπιστων, αποδοτικών, ασφαλών και οικονομικά αποδοτικών λύσεων cloud, και βοηθώντας τους συνεργάτες να διαμορφώσουν τις δικές τους προσφορές cloud υπηρεσιών. Communications Lead του Mosaic Inclusion Network στη Γερμανία, προωθώντας την πολυπολιτισμική συμπερίληψη και εκπροσώπηση.',
        },
        {
    ...
    community: {
      ...
      lead:
        'Πέρα από τη τεχνολογία, με συγκινούν οι πολυπολιτισμικές κοινότητες και η συμπερίληψη — να φέρνω ανθρώπους κοντά και να εξασφαλίζω ότι όλοι έχουν θέση στο τραπέζι.',
      items: [
        {
          title: 'Mosaic Inclusion Network',
          description:
  ...
  de: {
    ...
    hero: {
      ...
      stats: ['Sprachen', 'Länder, die ich Zuhause nenne', 'Jahre in der Tech-Branche', 'Pfade zum Erkunden'],
    },
    about: {
      eyebrow: 'Über mich',
