      ...
      topics: [
        {
          ...
          description:
            'Βοηθώ τους συνεργάτες να σχεδιάζουν και να αναπτύσσουν εφαρμογές AI που είναι αξιόπιστες, ασφαλείς και έτοιμες για παραγωγή — από το πρώτο prototype έως την κλιμάκωση, με έμφαση στο Microsoft Foundry.',
        },
        {
